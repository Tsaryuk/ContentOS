...
import {
  ...
  AlertTriangle, ArrowLeft, Loader2, EyeOff, Tag, Settings, GraduationCap,
} from 'lucide-react'
    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href={`/comments/youtube/${channelId}/coach`}
            ...
            title="Сравнить AI-draft и финальный ответ, оценить 👍/👎"
          >
